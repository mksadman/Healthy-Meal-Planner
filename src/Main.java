...
import service.*;
 ...
 public class Main {
     ...
     private static void loadMealsFromFiles() {
         // Define file paths
         String breakfastFilePath = "Meals/breakfast.txt";
         String lunchFilePath = "Meals/lunch.txt";
         String dinnerFilePath = "Meals/dinner.txt";
         String snacksFilePath = "Meals/snacks.txt";
     ...
     private static void createNewProfile() {
         ...
         System.out.print("Enter your dietary preference (Normal, Vegetarian, Vegan, Gluten-free, Low-Carb, Keto): ");
     ...
     private static void editCurrentProfile() {
         ...
         switch (choice) {
             ...
             case 6:
                 ...
                 break;
             case 7:
                 System.out.print("Enter new dietary preference (Normal, Vegetarian, Vegan, Gluten-free, Low-Carb, Keto): ");
     ...
     private static void viewMealSuggestions() {
         ...
         System.out.println("\n===== MEAL SUGGESTIONS =====");
         System.out.println("Your dietary preference: " + currentUser.getDietaryPreference());
